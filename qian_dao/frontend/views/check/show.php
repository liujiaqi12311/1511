...
$(function(){
                ...
                function showDate(yyyy,mm){
                    ...
                    $.ajax({
                        url:'http://localhost/xiao_yi/qian_dao/frontend/web/index.php?r=check/show1',
                        dataType:'json',
...
$(document).on('click','.f-day',function(){
    ...
    if(logday>newday){
        ...
        if($(this).parent().find("#aa").attr('class')!= ''){
            ...
            if(con == true){
                $.ajax({
                    url:'http://localhost/xiao_yi/qian_dao/frontend/web/index.php?r=check/bu',
                    data:{logday:logday},
                    type:'get',
                    dataType:'json',
                    success:function(msg){
        ...
        if($(this).parent().find("#aa").attr('class')!= ''){
            ...
            $.ajax({
            url:'http://localhost/xiao_yi/qian_dao/frontend/web/index.php?r=check/fen',
            data:{newday:newday},
            type:'get',
            dataType:'json',
            success:function(msg){
    ...
    if(date[2]==daysCount){
        $.ajax({
            url:'http://localhost/xiao_yi/qian_dao/frontend/web/index.php?r=check/di',
